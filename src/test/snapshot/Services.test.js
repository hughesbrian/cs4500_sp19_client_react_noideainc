...
import '../service/ServiceService.mock'
...
test('Create and Delete Services', () => {
    ...
    const testRenderer = TestRenderer.create(
        <Services services={services} editingService={clean3} deleteService={deleteService} saveService={saveService}/>
    );
    let tree = testRenderer.toJSON();
    expect(tree).toMatchSnapshot();
...
test('List of Services Renders Directly', () => {
    ...
    expect(servicenameField.props.value).toBe('nate');
