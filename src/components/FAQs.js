    ...
    <div className="faq-component">
        ...
        <table className="faq-table">
            ...
            <tr className="table-row">
                <td className="field title"> FAQ Title
                </td>
                <td className="field title"> FAQ Question
                </td>
            </tr>
            <tr className="table-row">
                <td><input value={title} placeholder="please input title" onChange={updateTitle}
                           className="field"></input></td>
                <td><input value={question} placeholder="please input question" onChange={updateQuestion}
                           className="field"></input></td>
            ...
            </tr>
            {
                faqs.map(faq =>
                    <tr className="table-row" key={faq.id}>
                        ...
                        <td>{faq.question}</td>
                        <td>
                            <Button onClick={() => deleteFAQ(faq.id)} className="buttons" variant="danger">
                                <TiTimesOutline/> </Button>
                            <Button onClick={() => moveToEdit(faq)} className="buttons"
                                    variant="primary"><TiEdit/></Button>
                        </td>
                    </tr>
                )
            }
